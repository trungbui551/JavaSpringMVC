                                ...
                                <div class="row g-4">
                                    <div class="col-lg-6">
                                        <div class="border rounded">
                                            <a href="#">
                                                <img src="/images/product/${pro.image}" class="img-fluid rounded"
                                                    alt="Image">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <c:forEach var="pro" items="${pros}">
                                    <div class="border border-primary rounded position-relative vesitable-item">
                                        <div class="vesitable-img">
                                            <img src="/images/product/${pro.image}" class="img-fluid w-100 rounded-top"
                                                alt="">
                                        </div>

                                        <a href="<%=request.getContextPath() %>/product/${pro.id}"> ${pro.name}
