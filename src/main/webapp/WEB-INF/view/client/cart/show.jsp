                    ...
                    <div class="container-fluid py-5 pt-5">
                        <div class="container py-5 pt-5">
                                            ...
                                            <c:forEach var="de" items="${cartDetail}" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group quantity mt-4" style="width: 100px;">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="${de.quantity}" data-cart-detail-id="${de.id}"
                                                    ...
                                                    <td>
                                                        ...
                                                        <p class="mb-0 mt-4" data-cart-detail-id="${de.id}">
                                                            <fmt:formatNumber type="number"
                                                                value="${de.price*de.quantity}" /> đ
                                                        </p>
                                                    </td>
                                                    <td>
                                                        <form action="/delete-cart-detail/${de.id}" method="post">
                                        ...
                                        <div class="bg-light rounded">
                                            <div class="p-4">
                                                ...
                                                <div class="d-flex justify-content-between mb-4">
                                                    ...
                                                    <p class="mb-0">
                                                        <span id="subtotal" data-cart-total-price="${totalPrice}">
                            ...
                            <c:if test="${empty cart}">
                                <h1>Bạn chưa thêm Sản Phẩm nào vào giỏ hàng của mình!</h1>
                                <hr />
                                <div class="d-flex justify-content-center"> <a href="/"
                                        class="btn btn-primary border-0 border-secondary py-3 px-4 position-absolute rounded-pill ">
