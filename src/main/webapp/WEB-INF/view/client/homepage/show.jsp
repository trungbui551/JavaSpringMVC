<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <body>
                <script>var currentUsername = "${pageContext.request.userPrincipal != null ? pageContext.request.userPrincipal.name : ''}";
                    if (!currentUsername) {
                        currentUsername = 'guest_' + Math.random().toString(36).substring(2, 11);
                    }</script>
